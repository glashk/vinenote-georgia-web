...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      <div className="hidden md:block relative bg-gradient-to-b from-white to-vineyard-50 border-b border-vineyard-100 shadow-[0_1px_3px_rgba(15,23,42,0.06)]">
        <Container>
          <nav className="relative flex items-center justify-between h-[4.5rem] px-4 sm:px-6">
            ...
            <div className="hidden md:flex items-center gap-2">
              <Link
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-full text-sm font-medium text-slate-700 hover:text-vineyard-600 hover:bg-vineyard-50 transition-all duration-200"
              >
                <NavIcon icon="app" />
                {t("nav.app")}
              </Link>
              <Link
                href="/my-listings/add"
                className="flex items-center gap-2 h-10 px-4 rounded-full bg-vineyard-500 text-white font-semibold text-sm hover:bg-vineyard-600 transition-all duration-200"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
